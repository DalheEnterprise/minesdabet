...
function handleClickGenerateOpportunity() {
    startCountdown(1); // Inicie a contagem regressiva de 60 segundos
	...
	statusElement.textContent = "Procurando uma Brecha";

	setTimeout(() => {
		statusElement.textContent = "Hackeando Mines...";
	}, 2000);

	setTimeout(() => {
		statusElement.textContent = "Mines Hackeado com Sucesso";
	}, 4000);
